...
def get_cub_class():
    ...
    with open("E:\\Supervised_Fine_Grained\\Platform_data_packaging\\FGVC_platform\\files\\cub_classes.txt", "r", encoding='UTF-8') as f:
        classes = f.readlines()
        classes_copy = []
        for i in classes:
...
if __name__ == "__main__":
    ...
    img_name = "E:\\cub\\CUB\\test\\001.Black_footed_Albatross\\Black_Footed_Albatross_0001_796111.jpg"
