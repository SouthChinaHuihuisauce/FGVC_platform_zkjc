...
print("Image.LOAD_TRUNCATED_IMAGES",Image.LOAD_TRUNCATED_IMAGES)
...
def knn_retrival(image_name, model):
    ...
    dir = 'E:/training_model/features/{}'.format(image_name.split('/')[-4])
...
if __name__ == "__main__":
    ...
    image_name = "E:/cub/CUB/test/001.Black_footed_Albatross/Black_Footed_Albatross_0001_796111.jpg"
